...
{
    public static class TechItemTableERandomJsonFileMapper
    {
        public static RollTableDto ToTechItemTableERandomTableRollTableDto(this string json)
        {
            var deserializedObject = json.JsonToObject<TechItemTableERoot>();
            ...
            foreach (var techItem in deserializedObject.TechItemTableE)
            {
    ...
    internal class TechItemTableEEntry
    {
        public string Range { get; set; }
        public string Tech { get; set; }
    }

    internal class TechItemTableERoot
    {
        public List<TechItemTableEEntry> TechItemTableE { get; set; }
    }
}

        ...
        public async Task<Result<Monster5eDto>> CreateOriginalDndMonster(float challengeRating)
            => await Safe.ExecuteAsync(async () =>
            {
                ...
                if (randomRole != CombatRoleEnum.Minion)
                {
                    ...
                    string roleBasedActions = await _openAiInterops.ChatGptResponseAsync(CreateRoleActionPrompt.GetPrompt(baseMonster, randomRole, originalLore, roleDescription, actionType, attackType));
